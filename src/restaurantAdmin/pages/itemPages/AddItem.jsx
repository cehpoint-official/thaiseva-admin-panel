                        ...
                        <div class="container mx-auto px-4">
                            <div class="max-w-3xl mx-auto ">
                                <form class=" rounded px-8  pb-8 mb-4">
                                    ...
                                    <div class="mb-4">
                                        <label class="block text-gray-700 text-sm font-bold mb-2" for="item-id">
                                            Item ID
                                        </label>
                                        <input class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline" id="item-id" type="text" placeholder="Item ID" />
                                    </div>
                                    ...
                                    <div class="mb-4">
                                        ...
                                        <input class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline" id="price" type="tel" placeholder="Price" />
                                    </div>
                                    ...
                                    <div class="mb-4">
                                        ...
                                        <input class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline" id="discount" type="email" placeholder="Discount" />
                                    </div>
                                    ...
                                    <div class="mb-4">
                                        ...
                                        <input class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline" id="catagory" type="text" placeholder="Select Category" />
                                    </div>

                                    <div class="mb-4">
                                        <label class="block text-gray-700 text-sm font-bold mb-2" for="itemtype">
                                            Item Type
                                        </label>
