...
const App = () => {
  async function requestPermission() {
    ...
    if (permission == "granted") {
      ...
      alert("You denied for the notificaiton");
    }
  }
          ...
          <Routes>
            ...
            <Route element={<PrivateRoute />}>
              ...
              <Route path='/' element={<Home />}>
                ...
                />
                <Route
                  path='restaurant/addrestaurant/restaInformation'
                  element={<RestaInformation />}
                />
                <Route
                  path='restaurant/EditRestaurant'
            ...
            <Route path='/foodAdmin' element={<MasterHome />}>
              ...
              <Route
                path='/foodAdmin/restaReuest/restaurantReqDet/:id'
                element={<RestaurantReqDet />}
              />

              <Route path='/foodAdmin/addResta' element={<AddResta />} />
              <Route
                path='/foodAdmin/addResta/addRestaurantInfo'
                element={<AddRestaInfo />}
              />

              <Route
                path='/foodAdmin/restaDetails'
                element={<RestaDetails />}
              />
              <Route
                path='/foodAdmin/restaDetails/restaDetailsView'
                element={<RestaDetailsView />}
              />

              <Route
                path='/foodAdmin/ordersDetails'
                element={<OrdersDetails />}
              />
              <Route
                path='/foodAdmin/ordersDetails/ordersDetView'
